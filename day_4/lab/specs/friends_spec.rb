...
def test_getting_tv_show
  ...
  assert_equal("X-Files", actual_result)
end
...
def test_likes_to_eat
  actual_result = likes_to_eat(@person2, "bread")
...
def test_add_friend
  ...
  actual_result = @person2[:friends].length()
...
def test_total_monies
  actual_result = total_monies(@people)
  assert_equal(143, actual_result)
end
...
def test_lend__monies
  actual_result = lend(@person5, @person1, 50)
  assert_equal(true, actual_result)
end
  # 8. Find the set of everyone's favourite food joined together
  # (hint: concatenate the favourites/snack arrays together)

def test_join_snacks
  actual_result = join_snacks(@people)
  assert_equal(["charcuterie", "soup", "bread", "Scooby snacks", "spaghetti", "ratatouille", "spinach"], actual_result)
end
